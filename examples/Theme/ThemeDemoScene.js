...
import TextArea from 'renderingEngine/ui/TextArea';

export default class DesignSystemScene extends Scene {
  create() {
    const { context } = this.Game.renderingContext;
    this.components = [];
    ...
    const heading1 = new Text(context, new Point(100, 100), 'Heading 1');
    const heading2 = new Text(context, new Point(100, 160), 'Heading 2');
    const heading3 = new Text(context, new Point(100, 220), 'Heading 3');
    const heading4 = new Text(context, new Point(100, 280), 'Heading 4');
    const heading5 = new Text(context, new Point(100, 340), 'Heading 5');

    const paragraph1 = new Text(context, new Point(500, 100), 'Lorem ipsum dolor sit amet, ac erat etiam suscipit odio egestas, viverra id.');
    const paragraph2 = new Text(context, new Point(500, 117), 'Lorem ipsum dolor sit amet, ac erat etiam suscipit odio egestas, viverra id.');

    const textAreaStyle = DesignSystemScene.createTextStyle(paragraphFont, 0, strokeStyle, undefined);
    const textArea = new TextArea(context, new Point(500, 200),
