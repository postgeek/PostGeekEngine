...
class PathBuilder {
  ...
  bezierCurveTo(controlPoint1, controlPoint2, endPoint) {
    const bezierCurveTo = () => this.path.context.bezierCurveTo(controlPoint1.x, controlPoint1.y, controlPoint2.x, controlPoint2.y, endPoint.x, endPoint.y);
  ...
  quadraticCurveTo(controlPoint, endPoint) {
    const quadraticCurveTo = () => this.path.context.quadraticCurveTo(controlPoint.x, controlPoint.y, endPoint.x, endPoint.y);
  ...
  arcTo(controlPoint1, controlPoint2, radius) {
    const arcTo = () => this.path.context.arcTo(controlPoint1.x, controlPoint1.y, controlPoint2.x, controlPoint2.y, radius);
