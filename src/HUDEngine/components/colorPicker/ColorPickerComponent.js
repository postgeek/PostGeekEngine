...
class ColorPickerComponent {
  ...
  createHSLSliders() {
    ...
    this.hueColorSlider.circleSelector.geometryStyle = new GeometryStyle({
      ...
      lineWidth: 2,
      fillStyle: new HSLAColor(hue, 100, 50, 1),
    });
  ...
  updateHSLRectangles() {
    const hue = Math.round(this.hslaColor.hue);
  ...
  updateHSLInputs() {
    ...
    this.hueColorSlider.circleSelector.geometryStyle.fillStyle = new HSLAColor(hue, 100, 50, 1);
  }
