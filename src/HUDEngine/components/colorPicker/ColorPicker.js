...
class ColorPicker {
  ...
  createRGBSliders() {
    ...
    const linearGradientRed = new LinearGradient(new Vec2D(160, 5), new Vec2D(415, 20));
    ...
    this.redColorSlider = new ColorSlider(new Vec2D(160, 5), 255, 30, red, redColorSliderGeometryStyle);
    ...
    this.greenColorSlider = new ColorSlider(new Vec2D(160, 35), 255, 30, green, greenColorSliderGeometryStyle);
    ...
    this.blueColorSlider = new ColorSlider(new Vec2D(160, 65), 255, 30, blue, blueColorSliderGeometryStyle);
  ...
  addSavedRectangle(color) {
    ...
    const savedRectangle = new Rectangle(new Vec2D(400 + offsetX * 25, 190 + offsetY * 25), 20, 20);
  ...
  hasRGBInputChanged() {
    return (
      this.hasRedTextValueChanged() ||
      this.hasRedSliderValueChanged() ||
      this.hasGreenTextValueChanged() ||
      this.hasGreenSliderValueChanged() ||
      this.hasBlueTextValueChanged() ||
      this.hasBlueSliderValueChanged()
    );
  }

  hasHSLInputChanged() {
    return (
      this.hasHueTextValueChanged() ||
